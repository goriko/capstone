...
public class InsideHistoryActivity extends Fragment {
    ...
    public InsideHistoryActivity(String id){
        this.Id = id;
    }
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_inside_history, container, false);
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot data : dataSnapshot.child("Guests").getChildren()){
                    DatabaseReference ref;
                    ref = FirebaseDatabase.getInstance().getReference("users").child(data.child("CompanionId").getValue().toString());
